...
public class Parser {
    public static Player readPlayerInfo(String fileName) throws FileNotFoundException, ParseException {
        ...
        if (input.hasNext())
            ...
            input.close();
            throw new ParseException("No info found", 0);
        }
        ...
        if (input.hasNext()) {
            ...
            input.close();
            throw new ParseException("No player name found", 1);
        }
        ...
        if (input.hasNext()) {
            ...
            input.close();
            throw new ParseException("No player surname found", 2);
        }
        ...
        if (input.hasNext()) {
            ...
            input.close();
            throw new ParseException("New line after surname expected", 2);
        }
